...
<head>
	...
	<title>Inck ~ Mid-to-Late Afternoon Edition</title>
</head>
				...
				<li class="set nine_columns contained">
					<ul>
						...
						<li class="set three_columns contained">
							<ul>
								<li class="module leader hyphenate">
									<h2><a href="page.php?number=J12">Departure Avoided</a></h2>
									<cite>by Nicholas Hall on January 13th, 2010</cite>
		...
		<li class="set three_columns">
			<ul>
				<li class="module leader hyphenate">
					...
					<p>Until recently, people had been thought to be angrily organizing to present challenges </p>
					<p>to the unfettered forward progress of Nick's plans, presumed to be gathering in airports and other public spaces, committed to causing some sort of generalized distress or inconvenience to Nick.</p>
					...
					<p>"Yeah I was kind of freaking out about everything and then I decided not to freak out anymore. So now I'm not freaking out," Nick said in a statement released to Liz Tan last night at Corner Bistro.</p>
					<p>This is not the first time that this event has occurred. During the preparations for other major events in the past, Nick has undergone a similar process.</p>
					<p>In almost all recorded cases, the process resulted in the cessation of the freaking out, and in a majority of cases that cessation came in the form of a decision, which is weird and seems to imply some future course of action.</p>
				</li>
			</ul>
		</li>
		<li class="set twelve_columns">
