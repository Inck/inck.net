				...
				<li class="set nine_columns contained">
					<ul>
						...
						<li class="set three_columns contained">
							<ul>
								<li class="module leader hyphenate">
									<h2><a href="page.php?number=P5">World Reacts as Anxiety is Decided Against</a></h2>
									...
									<p>Until recently, people had been thought to be angrily organizing to present challenges to the</p>
								</li>
							</ul>
						</li>
						<li class="set three_columns">
							<ul>
								<li class="module leader hyphenate">
									<p>unfettered forward progress of Nick's plans, presumed to be gathering in airports and other public spaces, committed to causing some sort of generalized distress or inconvenience to Nick.</p>
