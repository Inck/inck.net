					...
					<li class="set three_columns contained">
						<ul>
							<li id="top_right_one" class="module leader hyphenate">
								...
								<p>Additionally were seen the drinking of beer and plastic bottles of sangria, the throwing of the plastic bottles, fights, and an impromptu breakdancing session atop a dangerous internal roof.</p>
							</li>
						</ul>
					</li>
					<li class="set six_columns">
							...
							<li class="set three_columns contained">
								<ul>
									<li id="top_right_two" class="module leader hyphenate">
										<p>The breakdancing culminated in a young man somersaulting off of the dangerous roof and landing on the ground where he was then immobile.</p>
										<p>Rings of people then surrounded him, paramedics at the center, police around them, and concerned citizens and rubberneckers around them. </p>
										<p>Chants of 'idiota' briefly replaced those of other things to do with musicians and beauty</p>
									</li>
								</ul>
							</li>
							<li class="set three_columns">
